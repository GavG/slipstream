...
var pc
var port
var stun = "stun:blog.decloak.live:3478"
...
//config={"iceServers":[{"urls":["stun:blog.decloak.live:3478"],"username":"hello","credential":"bye"}],"iceTransportPolicy":"all","iceCandidatePoolSize":"0"}
...
// to fix DOM-based XSS issues - https://blog.decloak.live/slipstream/server?localip=1.1.1.1<img src onerror%3dalert(1)>
